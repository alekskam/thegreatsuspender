module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        config: {
            tempDir: (grunt.cli.tasks[0] === 'tgut') ? 'build/tgut-temp/' : 'build/tab-freeze-temp/',
            buildName: (grunt.cli.tasks[0] === 'tgut') ? 'tgut-<%= manifest.version %>' : 'tab-freeze-<%= manifest.version %>'
        },
        copy: {
            main: {
                expand: true,
